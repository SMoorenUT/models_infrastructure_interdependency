...
from parameter_generators import parameters_sampling_paper_3 as parameters_sampling
...
INPUT_SHEET_DIR = CURR_DIR.joinpath("EMA_input_sample_paper_3.xlsx")
...
TARGET_OF_OUTPUT = (
    "Original"  # Target of the output, can be "Surrogate", "Original", or "Both"
)
NA_VALUE = -999 # Value to read as NA values
...
def main():
    ...
    # for the sampling
    sampling_input_data, base_values_2019 = (
        ema_sampling.load_bandwith_data_multimodal(
            CURR_DIR.joinpath("EMA_input_sample_paper_3.xlsx")
        )
    )
    ...
    if TARGET_OF_OUTPUT in ["Original", "Both"]:
        ...
        parameters_sampling.create_parameter_files_multimodal(
