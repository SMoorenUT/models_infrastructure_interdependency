...
NAME = "green"
DISPLAY_NAME = "Multimodal green test scenario"
...
def make_config(
    ...
    return {
        ...
        "description": (
            f"PRONTO {DISPLAY_NAME} scenario. Calculations reference: Asgarpour, S.,"
            " Konstantinos, K., Hartmann, A. (2023). Infrastructure investment"
            " planning through scenario-based system-of-systems modelling."
        ),
        "models": models or [],
